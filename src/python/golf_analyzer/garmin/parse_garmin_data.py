...
class GarminDataExport:
    ...
    def __init__(self, input) -> None:
        ...
        with open(input) as file:
            ...
            (last_10_approach, appr_shot_orientation_df, dist_range_insights_df, club_insights_df) = self.process_last10_approach(golf_raw["last10DataApproach"])
    ...
    def process_shots(self, shot_details):  # an array of shot Details, which then is the hole + all the shots
        for hole in shot_details:
            ...
            shots_df = pd.DataFrame.from_dict(hole["shots"])  # we will still have some nesting under this
